...
Define how MacStorageAtlas collects explicitly selected scan results into a cleanup basket, presents honest reviewed cleanup totals, blocks protected or stale items, moves approved items to macOS Trash, reports partial outcomes, and preserves scan-result consistency and privacy boundaries.
