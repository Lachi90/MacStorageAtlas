...
Define how MacStorageAtlas performs opt-in exact duplicate analysis after a
completed scan, including candidate selection, byte-for-byte verification,
progress, cancellation, hardlink handling, cleanup-basket integration,
cloud-placeholder safety, and privacy boundaries.
