...
Define how MacStorageAtlas organizes Core source files so domain ownership, folder paths, namespaces, host-integration abstractions, and persisted-format compatibility remain clear.
